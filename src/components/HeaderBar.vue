<template>
  <div class="header-bar">
    ...
    <!-- <div class='Text-Style'>我是测试文字</div> -->
    <ul>
      <li>
        <router-link style="color: #9F7860" :to="{name : 'MovieView'}">电影</router-link>
      </li>
      <li>
        <router-link style="color: #E4A813" :to="{name : 'BookView'}">图书</router-link>
      </li>
      <li>
        <router-link style="color: #2AB8CC" :to="{name : 'BroadcastView'}">广播</router-link>
      </li>
      <li>
...
.header-bar {
  ...
  @font-face {
    font-family: lo;
    src : url('../assets/font/汉仪陈频破体简.ttf');
  }
  .Text-Style {
    /*使用字体*/
    font-family: lo;
